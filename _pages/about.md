...
I am a postdoctoral researcher in the [Fairness, Accountability, Transparency, and Ethics (FATE)](https://www.microsoft.com/en-us/research/theme/fate/) group at [Microsoft Research Montréal](https://www.microsoft.com/en-us/research/lab/microsoft-research-montreal/). I'm broadly interested in examining the social implications of natural language processing technologies. My research currently focuses on conceptualizing harms arising from language technologies, drawing on insights from fields such as sociolinguistics, linguistic anthropology, and education; on better measuring the social impacts of language technologies, including people's lived experiences with these technologies; and on uncovering how language technologies are produced, especially assumptions and constraints surrounding their production. I've also worked on using NLP approaches to examine language variation and change (computational sociolinguistics), for example developing models to identify language variation on social media.
...
**Apr. 2021:** We co-organized a [workshop](https://sites.google.com/view/hciandnlp/home) at the intersection of human-computer interaction and natural language processing (with Michael Madaio, Brendan O'Connor, Hanna Wallach, and Qian Yang).
